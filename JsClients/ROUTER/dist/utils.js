...
exports.sleep = exports.contractHashToByteArray = exports.contractDictionaryGetter = exports.getContractData = exports.getAccountNamedKeyValue = exports.getAccountInfo = exports.getStateRootHash = exports.getBinary = exports.getKeyPairOfContract = exports.createRecipientAddress = exports.camelCased = void 0;
...
var createRecipientAddress = function (recipient) {
    if (recipient instanceof casper_js_sdk_1.CLPublicKey) {
 ...
 */
var getStateRootHash = function (nodeAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var client, block;
...
var getAccountInfo = function (nodeAddress, publicKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getStateRootHash)(nodeAddress)];
            case 1:
...
var contractDictionaryGetter = function (nodeAddress, dictionaryItemKey, seedUref) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                stateRootHash = _a.sent();
                client = new casper_js_sdk_1.CasperServiceByJsonRPC(nodeAddress);
                return [4 /*yield*/, client.getDictionaryItemByURef(stateRootHash, dictionaryItemKey, seedUref)];
            case 2:
                storedValue = _a.sent();
                if (storedValue && storedValue.CLValue instanceof casper_js_sdk_1.CLValue) {
                    return [2 /*return*/, storedValue.CLValue];
                }
                else {
