...
// 			if (deploy.success) {
// 				console.log(`Successfull deploy of event : ${eventName}, deployHash: ${deploy.deployHash}`);
...
// 			} else {
// 				console.log(
// 					`Failed deploy of event ${eventName}, deployHash: ${deploy.deployHash}`
// 				);
...
// 	// const addLiquidityDeployHash = await uniswapRouter.add_liquidity(
// 	// 	KEYS,
// 	// 	TOKEN_A!,
// 	// 	TOKEN_B!,
// 	// 	AMOUNT_A_DESIRED!,
...
// 	// 	ADD_LIQUIDITY_PAYMENT_AMOUNT!
// 	// );
// 	// console.log("... Add Liquidity deploy hash: ", addLiquidityDeployHash);
	
// 	// await getDeploy(NODE_ADDRESS!, addLiquidityDeployHash);
// 	// console.log("... Add Liquidity successfully called.");
